...
Using Python to solve di<erential equation $\dot{s}=\alpha s^2+\beta s+\tau\left(s\right)$, the trends in space debris changes were obtained under different inputs 𝛾 with 𝛽. Showing as below

![](Figures/SpaceDebris.png)  

Bifurcation Exploring:  

Similarly, by using Python to solve the critical points of the differential equation, the bifurcation phenomena of critical points under different parameters can be obtained.
